---
title: CyclicBarrier原理
description: CyclicBarrier原理
date: 2022-07-28
slug: 
image: 
categories:
...
如下示意图，CyclicBarrier 和 CountDownLatch 很像，只是 CyclicBarrier 可以有不止一个栅栏，因为它的栅栏（Barrier）可以重复使用（Cyclic）。

![image-20220329232234853](http://moity-bucket.moity-soeoe.xyz/img/image-20220329232234853.png)
