...
var (
	...
	ErrVerificationCodeInvalid 		= &Errno{Code: 20117, Message: "验证码无效"}
	ErrVerificationCodeLength 		= &Errno{Code: 20118, Message: "验证码长度不正确"}
	ErrSendEmailVerificationCode 	= &Errno{Code: 20119, Message: "发送邮件验证码失败"}
